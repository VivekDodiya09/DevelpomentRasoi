    ...
    <>
      <div className="flex items-center justify-between px-4 py-3 border-b w-full sticky top-0 backdrop-blur-md z-[9999] border-restro-border-green">
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <div className="kbd kbd-sm rounded-lg">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={toggleTheme}
            className="p-2 rounded-full hover:bg-restro-button-hover transition"
            aria-label={
              theme === "light"
                ? t("appbar.switch_to_dark_mode")
                : t("appbar.switch_to_light_mode")
            }
          >
            {theme === "light" ? (
              <svg
