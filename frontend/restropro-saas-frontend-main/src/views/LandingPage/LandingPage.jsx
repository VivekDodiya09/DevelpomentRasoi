...
export default function LadingPage() {
  ...
  return (
    <div className="w-full bg-white text-gray-800">
      ...
      >
        {/* Plan 1: 6 Months */}
        <div className="rounded-2xl px-8 py-6 border flex flex-col w-full">
          <div className="bg-green-50 px-4 py-2 rounded-full w-fit mx-auto mb-4">
            <p className="text-sm font-semibold text-green-700">Most Popular</p>
          </div>
          <h3 className="text-3xl text-green-700 font-bold text-center">₹2,000</h3>
          <p className="text-gray-600 text-center mt-1 font-semibold">6 Months</p>
          <p className="text-center text-sm text-green-600 font-medium mt-2">+ 1 Month Free</p>
          <ul className="text-gray-700 mt-6 flex flex-col gap-3 text-start flex-1">
            ...
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold mt-0.5">✓</span>
              <span>Complete setup (menu, taxes, staff, devices)</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold mt-0.5">✓</span>
              <span>Training</span>
            ...
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold mt-0.5">✓</span>
              <span>Maintenance & basic support</span>
            </li>
          </ul>
          <button className="mt-8 bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded-lg transition active:scale-95">
            Get Started
          </button>
        </div>
        ...
        {/* Plan 2: Annual */}
        <div className="rounded-2xl px-8 py-6 border flex flex-col w-full">
          <h3 className="text-3xl text-green-700 font-bold text-center">₹2,500</h3>
          <p className="text-gray-600 text-center mt-1 font-semibold">Yearly</p>
          <p className="text-center text-sm text-green-600 font-medium mt-2">+ 1 Month Free</p>
          <ul className="text-gray-700 mt-6 flex flex-col gap-3 text-start flex-1">
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold mt-0.5">✓</span>
        ...
        {/* Plan 3: Monthly */}
        <div className="rounded-2xl px-8 py-6 border flex flex-col w-full">
          <h3 className="text-3xl text-green-700 font-bold text-center">₹299</h3>
          <p className="text-gray-600 text-center mt-1 font-semibold">Monthly</p>
          <p className="text-center text-sm text-gray-400 font-medium mt-2">&nbsp;</p>
          <ul className="text-gray-700 mt-6 flex flex-col gap-3 text-start flex-1">
            <li className="flex items-start gap-2">
              <span className="text-green-600 font-bold mt-0.5">✓</span>
              <span>Full system access</span>
