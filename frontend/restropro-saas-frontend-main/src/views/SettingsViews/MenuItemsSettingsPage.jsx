      ...
      <div className="mt-8 w-full grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
        {menuItems.map((menuItem, index) => {
          ...
          return (
            <div
              key={id}
              className={`px-4 py-3 rounded-2xl flex flex-wrap items-center gap-2 text-sm border border-restro-border-green ${
                !is_enabled ? "bg-gray-200 dark:bg-gray-900 opacity-50" : ""
              }`}
            >
      ...
      <dialog id="modal-add" className="modal modal-bottom sm:modal-middle ">
        <div className="modal-box border border-restro-border-green dark:rounded-2xl">
          ...
          <div className="mt-4">
            <label
              htmlFor="title"
              className={`mb-1 block text-gray-500 text-sm font-medium`}
            >
